# Exercise 1 - Lab Overview and Setup (.NET Edition)

#### Duration: 15 minutes

## Overall Lab Objectives

Thishands-on lab is designed to give developers practical experience using **GitHub Copilot** as an AI-powered assistant throughout the Software Development Life Cycle (SDLC). You will explore how GitHub Copilot can improve developer productivity, code quality, testing, code review, and remediation.
...
1. Navigate to the **hol-copilot-lab-net** repository in a web browser.

   ```
   https://github.com/Coveros/hol-copilot-lab-net/tree/main
   ```
...
In this lab, you successfully set up your development environment, logged into GitHub, created a new repository, and configured Visual Studio Code with GitHub Copilot. You are now ready to explore the .NET Blazor WebAssembly application!
